            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <h4 class="py-3 breadcrumb-wrapper mb-4">
                        <span class="text-muted fw-light">Formulario /</span> Serviço
                    </h4>

                        <!-- Form controls -->
                        <div class="center-content">
                            <div class="card mb-4">
                                <h5 class="card-header">Novo Serviço</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4 ">
                                                ...
                                                <input type="text" class="form-control" name="request"  placeholder="Nome" />
                                            </div>
                                            <div class="col-4">
                                                <label for="exampleFormControlReadOnlyInput1" class="form-label">Data do Serviço</label>
                                                <input class="form-control" type="date"name="data_service">
                                            </div>
                                            <div class="col-4 ">
                                    ...
                                    <div style="margin-top: -40px" class="card-body">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <input type="text" class="form-control"  name="service" placeholder="Nome" />
                                            </div>

                                            <div class="col-4">
                                                <label for="exampleFormControlSelect1" class="form-label">Local</label>
                                                <select class="form-control" name="place" id="">
                                                    <option value="">Selecione um tipo</option>
                                                    <option value="mix">Mundial-Mix</option>
                                                    <option value="design">Mundial-Design</option>
                                                    <option value="mix">Mundial-Galpão</option>

                                                </select><br>
                                            </div>

                                            <div class="col-4">
                                                <label for="exampleFormControlReadOnlyInput1" class="form-label">Valor</label>
                                                <input class="form-control"  name="value" type="text" placeholder="150,00" >
                                                <input  class="form-control" type="hidden" name="situation" value="pendent">
                                            </div>

                                            <div class="mt-4">
                                                <input class="btn btn-secondary add-new btn-primary" type="submit" value="Cadastrar">
                                            </div>

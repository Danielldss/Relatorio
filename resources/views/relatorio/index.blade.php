            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <h4 class="py-3 breadcrumb-wrapper mb-4">
                        <span class="text-muted fw-light"></span> Relatorio
                    </h4>
                    <!-- Bootstrap Table with Header - Dark -->
                    <div class="card">
                        <form action="{{route('admin.list-service')}}" method="GET">
                            <div class="row">
                                <div class="col-sm-2">
                                    <h5 class="card-header">Serviços</h5>
                                </div>
                                <div  class="col-sm-2 ">
                                    <input name="data" value="{{ old('data', $filtro) ?? now()->format('Y-m') }}" style="margin-top: 13px" class="form-control" type="month">
                                </div>

                                <div class="col-sm-2">
                                    <button style= "margin-right:15px;background: #495563;margin-top: 13px;  border: none" type="submit" class="btn btn-primary">Buscar</button>

                                </div>


                                <div class="col-sm-6  text-end">
                                    <a  style="margin-right:15px;background: #495563;margin-top: 13px; border: none" href="/relatorio/exportar-pdf/index?data={{ $filtro  }}" class="btn btn-primary">Exportar PDF</a>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tbody  class="table-border-bottom-0">
                                    @foreach( $relatorios as $service )
                                        <tr>
                                            ...
                                            <td>{{ \App\Models\Help::traduzirPalavra($service->place) }}</td>
                                            <td>{{ date('d/m/y', strtotime($service->data_service)) }}</td>
                                            <td>{{\App\Models\Help::formatarMoeda($service->value) }}</td>
                                            @if($service->situation == 'pendent')
                                            <td><span class="badge bg-label-danger me-1">{{ \App\Models\Help::traduzirPalavra($service->situation) }}</span></td>
                                            @else
                                             <td><span class="badge bg-label-success me-1">{{ \App\Models\Help::traduzirPalavra($service->situation) }}</span></td>
                                            @endif
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('admin.edit-service', ['id' => $service->id]) }}"><i class="bx bx-edit-alt me-1"></i>Editar</a>
                                                        <a class="dropdown-item" href="{{ route('admin.delete-service', ['id' => $service->id]) }}"><i class="bx bx-trash me-1"></i> Deletar</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <tr>
                                    <thead>
                                            <td style="background:#F3F4F4;border: none" colspan="7"></td>
                                            <th style="color: white;background:#495563;text-align: center;border: none" colspan="2">TOTAL:{{ \App\Models\Help::formatarMoeda($totalService) }}</th>
                    ...
                    <div style="margin-top: 5px;background:#F3F4F4;border: none"  class="table-border-bottom-0">
                        {{ $relatorios->onEachSide(3)->links('pagination::bootstrap-4') }}
                    </div>
                </div>

...
<head>
    ...
    <title>Tables - Basic Tables | Frest - Bootstrap Admin Template</title>
                ...
                <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal  menu bg-menu-theme flex-grow-0">
                    ...
                    <div class="container-xxl d-flex h-100">
                        <ul class="menu-inner">
                            ...
                            <!-- Orçamentos -->
                            <li class="menu-item">
                                <a href="admin.new-orcamentos" class="menu-link">
...
">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="py-3 breadcrumb-wrapper mb-4">
                        <span class="text-muted fw-light">Tabela  /</span> Orçamento
                    </h4>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                @foreach($orcamentos as $orcamento )
                                    <tbody>
                                        <td>{{ $orcamento->id }}</td>
                                        <td>{{ $orcamento->request }}</td>
                                        <td>{{ $orcamento->place }}</td>
                                        <td>{{ $orcamento->data_service }}</td>
                                        <td>{{ \App\Models\Help::formatarMoeda($totalOrcamentos->total) }}</td>
                                        <td>
                                            <a style="color: blue;padding: 0 5px 0 5px" href="{{ route('admin.item-orcamentos',['id' =>$orcamento->id])}}"><i class="far fa-file-pdf"></i></a>
                                            <a style="color: #8a1fcf;padding: 0 5px 0 5px" href=""><i class="fas fa-pencil-alt"></i></a>
                                            <a style="color: red" href="{{ route('admin.delete-orcamentos',['id' =>$orcamento->id])}}"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tbody>
                                @endforeach
                            </table>
                    ...
                    <div class="col-2 mt-5" style="text-align: left">
                        <button class="form-control badge badge-primary "> <a style="margin-left: 10px" href="{{ route('admin.new-service') }}">Novo Orçamento</a></button>
                    </div>

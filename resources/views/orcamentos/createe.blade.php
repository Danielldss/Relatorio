                            ...
                            <div class="card mb-4">
                                ...
                                <form action="{{route('admin.store-orcamentos')}}" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4 ">
                                                <input type="hidden" class="form-control"  value="pendent" name="situation"  placeholder="Nome" />
                                            ...
                                            <div class="col-4">
                                                <label for="exampleFormControlReadOnlyInput1" class="form-label">Data do Orçamento</label>
                                                <input class="form-control" type="date"name="data_budget">
                                            </div>
                                            <div class="col-4 ">
                                            ...
                                            <div class="col-4">
                                                <label class="form-label" for="">Valor Mão de obra</label><br>

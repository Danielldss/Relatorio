...
">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="py-3 breadcrumb-wrapper mb-4">
                        <span class="text-muted fw-light"></span> Orçamento
                    </h4>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                @foreach($orcamentos as $orcamento )
                                    ...
                                    <td>{{ \App\Models\Help::formatarMoeda($totalOrcamentos) }}</td>
                                    <td class="text-center">
                                        ...
                                        <a style="color: green;padding: 0 10px 0 0" href="{{ route('admin.produto-orcamentos',['id' =>$orcamento->id])}}"><i class="fas fa-plus-circle"></i></a>
